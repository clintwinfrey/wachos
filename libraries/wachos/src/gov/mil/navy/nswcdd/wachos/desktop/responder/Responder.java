...
/**
 * Responders are added to a NanoServer in order to provide a server response
 */
public interface Responder {
    ...
    /**
     * Provides a response to the server request
     *
    ...
    /**
     * Gets a value that matches the provided parameter ID
     *
     * @param params the parameters to choose from
     * @param paramId the ID of the parameter
     * @return the value of the parameter ID
     */
    public default String getParameter(Map<String, List<String>> params, String paramId) {
        List<String> param = params.get(paramId);
